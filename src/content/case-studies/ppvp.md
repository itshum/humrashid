...
timeframe: "2023"
teamSize: "Nessa"
coverImage: "/case-studies/ppvp/01-hero-desktop.webp"
coverImageAlt: "PPVP investment app home screen shown on a phone, held in hand"
challengeHeading: "Institutional deal flow, opened up to individual investors"
problem: |
...
challengeImage: "/case-studies/ppvp/07-s01-guided-onboarding-a.webp"
challengeImageAlt: "Welcome, waitlist, and invite code entry screens for PPVP"
approachHeading: "An elegant system, built for trust before anything else"
approach: |
  Since exclusivity was the entire selling point, I started with the design system rather than any one flow: a restrained, editorial type system and a quiet color palette that read as premium on sight, not after ten minutes of use. Everything downstream, sign-up, onboarding, the deal feed, the admin panel, had to inherit that same tone so the app never broke character between an investor's first tap and a deal closing.
navSystemImage:
  src: "/case-studies/ppvp/05-design-ref-1.png"
  alt: "Pari Passu Venture Partners wordmark over a dark, textured background"
solutionHeading: "Mechanics behind an invite-only investment platform"
solutionItems:
  - tag: "1. Invite Only & Guided Onboarding"
  ...
  - tag: "3. Deal Discovery"
    heading: "Explore active deals without losing the thread"
    image: "/case-studies/ppvp/23-s01-deal-info-2.webp"
    imageAlt: "Portfolio summary and a filterable list of active deals"
    body: |
  ...
  - tag: "4. UI Kit for Scale"
    heading: "A component system built to outlast launch"
    image: "/case-studies/ppvp/27-design-ref-3.png"
    imageAlt: "UI kit reference sheet showing toggles, list rows, buttons, and FAQ components"
    body: |
      PPVP's team was always going to keep adding features after launch, so the interface kit was built as a real system, not a one-off screen library: form fields, buttons, cards, and interaction patterns that could be recombined without a designer in the room every time. The same deal template reused across mobile and desktop contexts is a small example of the bigger idea, one component, built once, holding up everywhere it's needed.
  - tag: "5. Admin Publishing Tools"
...
dashboardImage: "/case-studies/ppvp/12-design-ref-2.png"
dashboardImageAlt: "Sign in, past experience, push notification, and verification screens in the onboarding flow"
item1Image: "/case-studies/ppvp/19-s01-deal-discovery-2.webp"
item1ImageAlt: "PPVP news feed shown on a phone, held in hand"
item4Grid:
  - src: "/case-studies/ppvp/31-s02-investor-profiles-1.webp"
    alt: "Filter builder for investor profiles by status, invited by, and investment amount"
...
postQuoteGrid:
  - src: "/case-studies/ppvp/29-s02-publishing-powerhouse-1.webp"
    alt: "PPVP admin panel showing a company profile, deals, and founder asks"
outcomeHeading: "Real traction with real investors"
outcome: |
  The app launched with an average investor check size of $10k and a 5.0 average rating, holding the premium, invite-only feel through to how people actually used it, not just how it looked on the way in.
order: 3
draft: false
---
